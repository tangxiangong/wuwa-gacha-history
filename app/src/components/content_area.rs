...
pub fn ContentArea() -> Element {
    ...
    rsx! {
        div { class: "flex flex-col gap-4 h-full",
            ...
            div { class: "min-h-40",
                match view_now {
                    ViewMode::Bars    => rsx! { crate::components::bars_view::BarsView    { pulls: chrono.clone() } },
                    ViewMode::Cards   => rsx! { crate::components::cards_view::CardsView  { pulls: chrono.clone() } },
                    ViewMode::Summary => rsx! { crate::components::summary_view::SummaryView { pulls: chrono.clone() } },
                }
            }
